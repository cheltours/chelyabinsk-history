            ...
            <div className="modal">
                ...
                <div className="modal-content">
                    ...
                    <section className="modal-page">
                        {settingPage === 'app' && (
                            <AppSection setTheme={setAppTheme} getTheme={getAppTheme} updateTheme={updateAppTheme} />
                        )}
    ...
    return (
        <div className="privacy-policy-section">
            ...
            <div className="policy-container">
                <p>
                    Настоящая политика описывает, как обрабатываются данные в приложении. Приложение разработано в
                    учебных целях и не собирает, не хранит и не передаёт ваши персональные данные.
                </p>

                <br />

                <p>
                    <b>1. Хранение данных</b>
                </p>
                <p>
                    Все данные, создаваемые вами (например, избранные места, настройки), сохраняются исключительно на
                    вашем устройстве (локальное хранилище браузера). Мы не отправляем эти данные на наши серверы и не
                    имеем к ним доступа.
                </p>
                ...
                <p>
                    <b>2. Использование базы данных</b>
                </p>
                <p>
                    Внешняя база данных используется только для загрузки готовых материалов (репортажей, статей о
                    достопримечательностях). Эти материалы не содержат персональных данных и не могут быть изменены
                    вами. Ваши личные данные в базу не передаются.
                </p>
                ...
                <p>
                    Приложение может запрашивать ваше местоположение через встроенный Geolocation API браузера. Это
                    происходит только на вашем устройстве; координаты никуда не передаются и не сохраняются на сервере.
                    Вы можете отозвать разрешение в любой момент через настройки браузера.
                </p>
                ...
                <p>
                    Если у вас есть вопросы, вы можете сообщить о них через{' '}
                    <a href="https://github.com/levalyukov/chelyabinsk-history/issues">GitHub Issues</a> репозитория
                    проекта.
                </p>
                ...
                <p>
                    <i>Дата последнего обновления: 24 марта 2026 г.</i>
                </p>
            </div>
        </div>
    )
            ...
            <div className="licenses-section-content">
                {Object.entries(licenses).map(([key, index]) => (
                    <button
                        ...
                        <span>
                            <FontAwesomeIcon icon={index.icon} /> {index.title}
                        </span>{' '}
                        <p className="license">{index.license}</p>
                    </button>
                ))}
            </div>
        </div>
